...
void main() => runApp(MaterialApp(home: planificacion()));
...
class planificacion extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        scaffoldBackgroundColor: const Color(0x0000), // fondo de todo
      ),
      home: Scaffold(
        appBar: AppBar(
              ...
              ElevatedButtonTheme(
                data: ElevatedButtonThemeData(
                  style: ElevatedButton.styleFrom(
                    backgroundColor: const Color(0xEADE72),
                  ...
                  child: Column(
                    children: <Widget>[
                      ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          backgroundColor:
                              const Color.fromRGBO(236, 67, 33, 1.0),
                          padding: const EdgeInsets.symmetric(
                      ...
                      ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          backgroundColor:
                              const Color.fromRGBO(252, 153, 34, 1.0),
                          padding: const EdgeInsets.symmetric(
                              horizontal: 20, vertical: 10),
                          maximumSize: const Size(
                              200,
                      ...
                      ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          backgroundColor:
                              const Color.fromRGBO(82, 218, 61, 1.0),
                          padding: const EdgeInsets.symmetric(
                              horizontal: 20, vertical: 10),
                          maximumSize: const Size(
                              200,
                      ...
                      ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          backgroundColor:
                              const Color.fromRGBO(65, 194, 194, 1.0),
                          padding: const EdgeInsets.symmetric(
                              horizontal: 20, vertical: 10),
                          maximumSize: const Size(
                              200,
