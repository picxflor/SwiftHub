...
Widget chatBox(String name, String text, String imageUrl, BuildContext context) {
    return InkWell(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => ChatInter(name, text, imageUrl)),
        );
      },
      child: Padding(
        padding: EdgeInsets.all(8.0),
