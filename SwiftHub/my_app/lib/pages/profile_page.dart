                ...
                children: [
                  ...
                  Container(
                    margin: EdgeInsets.all(
                        10), // Margin of 20 for the second button
                    child: ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                            context,
                  ...
                  Container(
                    margin:
                        EdgeInsets.all(10), // Margin of 20 for the third button
                    child: ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                            context,
                  ...
                  Container(
                    margin: EdgeInsets.all(
                        10), // Margin of 20 for the fourth button
                    child: ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                            context,
                  ...
                  Container(
                    margin:
                        EdgeInsets.all(10), // Margin of 20 for the fifth button
                    child: ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                            context,
          ...
          switch (index) {
            case 0:
              ...
              Navigator.of(context)
                  .push(MaterialPageRoute(builder: (context) => quehacer()));
              break;
            case 1:
